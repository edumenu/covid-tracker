    ...
    return (
        ...
        <div className="bg-gray-100 rounded rounded-t-lg overflow-hidden object-center mx-auto shadow max-w-3xl">
            <div className="flex justify-center mt-8">
                <img src="https://www.countryflags.io/TZ/shiny/64.png" alt="Country" className="h-24 rounded-md" />		
            </div>
            <div className="text-center px-3 pb-4">
                <h1 className="text-black text-2xl bold font-sans">Ghana</h1>
            </div>
            <div className="px-12 sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                <div id="jh-stats-positive" className="flex flex-col justify-center px-1 bg-white shadow-md border-b-2 border-gray-300 rounded">
                    ...
                    <p className="text-2xl font-semibold text-center text-gray-800">43</p>
                    <p className="text-md text-center text-gray-500">Total number of countries</p>
                </div>
            ...
            <div class="md:w-1/2 sm:w-full rounded-lg shadow-lg bg-white mx-auto my-8">
                <div class="flex border-b border-gray-100 px-5 py-4">
                    <span class="font-bold mx-auto text-gray-700 text-lg">More Information</span>
                    <div>
                        <button><i class="fa fa-times-circle text-red-500 hover:text-red-600 transition duration-150"></i></button>
                    </div>
                </div>
            
                <div class="block flex overflow-y-auto px-10 py-3 text-gray-600">
